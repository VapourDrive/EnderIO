...
public class BlockItemPaintedDoor extends ItemBlock {

  public BlockItemPaintedDoor(Block p_i45328_1_) {
    super(p_i45328_1_);
    setHasSubtypes(true);
  }

  public BlockItemPaintedDoor() {
    super(EnderIO.blockPaintedDoor);
    setHasSubtypes(true);
  }
  ...
  public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8,
    ...
    if(par7 != 1) {
      ...
      ++par5;
      Block block = EnderIO.blockPaintedDoor;
